          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  act(params) {
                    const { booking, referentienummer } = params;

                    return remarkService.add({
                      booking: booking.id,
                      message: `Boete CJIB ${referentienummer ? `[ref.nr. ${referentienummer}]` : ``} in rekening gebracht`,
                      type: "custom"
                    })
                    .then(remark => {
                ...
                {
                  label: "Brief CJIB opmaken",
                  act(params) {
                    const { contractor, referentienummer } = params;
                    function showPopup(e) {
                      const win = window.open("", "Brief CJIB");
                      win.document.body.innerHTML = commonTags.stripIndent`
                        <html>
                        <head>
                        ...
                        <body>
                          ...
                          <p>
                            ...
                            Plaats en datum: Amsterdam, 17 juli 2019<br />
                            Handtekening:<br />
                          </p>
